...
//! infrastructure/ — 扩展点 trait（Store / Serializer / Lifecycle / Observer）
...
pub use domain::{
    ...
    message::{Message, MessageId, MessageRole, MessageStatus, MessageStatusError},
...
pub use infrastructure::{
    JsonSessionSerializer, NoopSessionLifecycle, SessionLifecycle, SessionObserver,
    SessionSerializer, SessionStore,
};
